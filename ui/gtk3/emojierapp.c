/* emojierapp.c generated by valac 0.52.4, the Vala compiler
...
static void ___lambda25_ (EmojiApplication* self,
                   guint i,
                   guint b,
                   guint s);
static void ____lambda25__ibus_emojier_candidate_clicked (IBusEmojier* _sender,
                                                   guint index,
                                                   guint button,
                                                   guint state,
                                                   gpointer self);
static void ___lambda26_ (EmojiApplication* self);
static void ____lambda26__ibus_emojier_cancel (IBusEmojier* _sender,
                                        gpointer self);
static void ___lambda27_ (EmojiApplication* self);
gchar* ibus_emojier_get_selected_string (IBusEmojier* self);
static void ____lambda27__ibus_emojier_commit_text (IBusEmojier* _sender,
                                             const gchar* text,
                                             gpointer self);
...
static void
___lambda25_ (EmojiApplication* self,
              guint i,
              guint b,
              guint s)
{
...
static void
____lambda25__ibus_emojier_candidate_clicked (IBusEmojier* _sender,
                                              guint index,
                                              guint button,
                                              guint state,
                                              gpointer self)
{
	___lambda25_ ((EmojiApplication*) self, index, button, state);
}
...
static void
____lambda26__ibus_emojier_cancel (IBusEmojier* _sender,
                                   gpointer self)
{
	___lambda26_ ((EmojiApplication*) self);
}
...
static void
____lambda27__ibus_emojier_commit_text (IBusEmojier* _sender,
                                        const gchar* text,
                                        gpointer self)
{
	___lambda27_ ((EmojiApplication*) self);
                                 ...
                                 GApplicationCommandLine* command_line)
{
	...
	if (_tmp48_ == NULL) {
		...
		IBusEmojier* _tmp52_;
		IBusEmojier* _tmp53_;
		_tmp49_ = ibus_emojier_new ();
		g_object_ref_sink (_tmp49_);
		_g_object_unref0 (self->priv->m_emojier);
		self->priv->m_emojier = _tmp49_;
		_tmp50_ = self->priv->m_emojier;
		gtk_application_add_window ((GtkApplication*) self, (GtkWindow*) _tmp50_);
		_tmp51_ = self->priv->m_emojier;
		g_signal_connect_object (_tmp51_, "candidate-clicked", (GCallback) ____lambda25__ibus_emojier_candidate_clicked, self, 0);
		_tmp52_ = self->priv->m_emojier;
		g_signal_connect_object (_tmp52_, "cancel", (GCallback) ____lambda26__ibus_emojier_cancel, self, 0);
		_tmp53_ = self->priv->m_emojier;
		g_signal_connect_object (_tmp53_, "commit-text", (GCallback) ____lambda27__ibus_emojier_commit_text, self, 0);
	}
