/* candidatepanel.c generated by valac 0.52.4, the Vala compiler
                                  ...
                                  IBusLookupTable* table)
{
	...
	if (table != NULL) {
		IBusOrientation _tmp16_;
		_tmp16_ = orientation;
		candidate_panel_set_orientation (self, _tmp16_);
	}
	_tmp17_ = candidates;
	_tmp17__length1 = candidates_length1;
