...
static gboolean ___lambda20__gtk_widget_button_press_event (GtkWidget* _sender,
...
static void ___lambda21__gtk_list_box_row_activated (GtkListBox* _sender,
                                              GtkListBoxRow* row,
                                              gpointer self);
static void __lambda22_ (IBusEmojier* self,
                  GtkWidget* w,
                  GtkAllocation* a);
static void ___lambda22__gtk_widget_size_allocate (GtkWidget* _sender,
                                            GtkAllocation* allocation,
                                            gpointer self);
...
static void __lambda18_ (IBusEmojier* self,
                  guint i,
                  guint n);
static void ___lambda18__ibus_emojier_load_progress_object_deserialize_unicode (IBusEmojierLoadProgressObject* _sender,
                                                                         guint done,
                                                                         guint total,
                                                                         gpointer self);
...
static gint __lambda11_ (const gchar* a,
                  const gchar* b);
...
static void ibus_emojier_show_code_point_description (IBusEmojier* self,
                                               const gchar* text);
static gboolean ___lambda10_ (IBusEmojier* self,
                       GtkWidget* w,
                       GdkEventButton* e);
static gboolean ____lambda10__gtk_widget_button_press_event (GtkWidget* _sender,
                                                      GdkEventButton* event,
                                                      gpointer self);
...
static gboolean _____lambda12_ (Block2Data* _data2_,
                         GtkWidget* w,
                         GdkEventButton* e);
static gboolean ______lambda12__gtk_widget_button_press_event (GtkWidget* _sender,
                                                        GdkEventButton* event,
                                                        gpointer self);
...
static gboolean __lambda14_ (IBusEmojier* self);
static gboolean ___lambda14__gsource_func (gpointer self);
static gboolean ______lambda13__gtk_widget_motion_notify_event (GtkWidget* _sender,
...
___lambda23__gtk_list_box_row_activated (GtkListBox* _sender,
                                         ...
                                         gpointer self)
{
	__lambda23_ ((IBusEmojier*) self, _sender, row);
}
...
ibus_emojier_show_category_list (IBusEmojier* self)
{
	...
	g_signal_connect_object ((GtkListBox*) _tmp21_, "row-activated", (GCallback) ___lambda23__gtk_list_box_row_activated, self, 0);
...
static gboolean
___lambda20__gtk_widget_button_press_event (GtkWidget* _sender,
                                            GdkEventButton* event,
                                            gpointer self)
{
	gboolean result;
	result = __lambda20_ ((IBusEmojier*) self, _sender, event);
	return result;
}
...
static void
___lambda21__gtk_list_box_row_activated (GtkListBox* _sender,
                                         GtkListBoxRow* row,
                                         gpointer self)
{
	__lambda21_ ((IBusEmojier*) self, _sender, row);
}
...
static void
___lambda22__gtk_widget_size_allocate (GtkWidget* _sender,
                                       GtkAllocation* allocation,
                                       gpointer self)
{
	__lambda22_ ((IBusEmojier*) self, _sender, allocation);
}
...
ibus_emojier_show_unicode_blocks (IBusEmojier* self)
{
	...
	_tmp17_ = button;
	g_signal_connect_object ((GtkWidget*) _tmp17_, "button-press-event", (GCallback) ___lambda20__gtk_widget_button_press_event, self, 0);
	...
	g_signal_connect_object ((GtkListBox*) _tmp32_, "row-activated", (GCallback) ___lambda21__gtk_list_box_row_activated, self, 0);
	n = (guint) 0;
	...
	row = _tmp59_;
	_tmp60_ = row;
	g_signal_connect_object ((GtkWidget*) _tmp60_, "size-allocate", (GCallback) ___lambda22__gtk_widget_size_allocate, self, 0);
	_g_object_unref0 (row);
	_g_object_unref0 (adjustment);
	_g_object_unref0 (viewport);
...
ibus_emojier_show_arrow_buttons (IBusEmojier* self)
{
	...
	prev_button = _tmp7_;
	_tmp8_ = prev_button;
	g_signal_connect_object (_tmp8_, "clicked", (GCallback) ___lambda16__gtk_button_clicked, self, 0);
	_tmp9_ = prev_button;
	...
	if (g_strcmp0 (_tmp32_, "") != 0) {
		...
		g_signal_connect_data (_tmp39_, "clicked", (GCallback) ____lambda17__gtk_button_clicked, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	}
...
static void
___lambda18__ibus_emojier_load_progress_object_deserialize_unicode (IBusEmojierLoadProgressObject* _sender,
                                                                    guint done,
                                                                    guint total,
                                                                    gpointer self)
{
	__lambda18_ ((IBusEmojier*) self, done, total);
}
...
ibus_emojier_show_unicode_progress_bar (IBusEmojier* self)
{
	...
	g_signal_connect_object (_tmp19_, "deserialize-unicode", (GCallback) ___lambda18__ibus_emojier_load_progress_object_deserialize_unicode, self, 0);
	if (self->priv->m_unicode_progress_id > ((guint) 0)) {
		g_source_remove (self->priv->m_unicode_progress_id);
	}
	self->priv->m_unicode_progress_id = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 100, ___lambda19__gsource_func, g_object_ref (self), g_object_unref);
	_g_object_unref0 (label);
...
{
	gint result;
	result = __lambda11_ ((const gchar*) a, (const gchar*) b);
	return result;
}
...
ibus_emojier_update_category_list (IBusEmojier* self)
{
	...
	categories = _tmp6_;
	categories = g_list_sort (categories, ___lambda11__gcompare_func);
	_tmp7_ = categories;
	{
...
static gboolean
____lambda10__gtk_widget_button_press_event (GtkWidget* _sender,
                                             GdkEventButton* event,
                                             gpointer self)
{
	gboolean result;
	result = ___lambda10_ ((IBusEmojier*) self, _sender, event);
	return result;
}
                ...
                GdkEventButton* e)
{
	...
	g_return_val_if_fail (e != NULL, FALSE);
	_tmp0_ = e->state;
	g_signal_emit (self, ibus_emojier_signals[IBUS_EMOJIER_CANDIDATE_CLICKED_SIGNAL], 0, _data2_->index, e->button, (guint) _tmp0_);
	result = TRUE;
	return result;
}

static gboolean
______lambda12__gtk_widget_button_press_event (GtkWidget* _sender,
                                               GdkEventButton* event,
                                               gpointer self)
{
	gboolean result;
	result = _____lambda12_ (self, _sender, event);
	return result;
}
...
{
	gboolean result;
	result = __lambda14_ ((IBusEmojier*) self);
	return result;
}
                ...
                GdkEventMotion* e)
{
	...
	self->priv->m_entry_notify_show_id = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 100, ___lambda14__gsource_func, g_object_ref (self), g_object_unref);
	result = FALSE;
	__vala_GdkEventMotion_free0 (pe);
	return result;
}
...
static gboolean
______lambda13__gtk_widget_motion_notify_event (GtkWidget* _sender,
                                                GdkEventMotion* event,
                                                gpointer self)
{
	gboolean result;
...
ibus_emojier_show_candidate_panel (IBusEmojier* self)
{
	...
	if (_tmp3_ != NULL) {
		...
		g_signal_connect_object ((GtkWidget*) _tmp11_, "button-press-event", (GCallback) ____lambda10__gtk_widget_button_press_event, self, 0);
		_g_object_unref0 (label);
	...
	n = 0;
	{
		...
		i = page_start_pos;
		{
			...
			while (TRUE) {
				...
				g_signal_connect_data ((GtkWidget*) _tmp52_, "button-press-event", (GCallback) ______lambda12__gtk_widget_button_press_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
				_tmp53_ = candidate_ebox;
				g_signal_connect_data ((GtkWidget*) _tmp53_, "motion-notify-event", (GCallback) ______lambda13__gtk_widget_motion_notify_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
				_tmp54_ = grid;
...
ibus_emojier_enter_notify_disable_with_timer (IBusEmojier* self)
{
	...
	self->priv->m_entry_notify_show_id = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 100, ___lambda24__gsource_func, g_object_ref (self), g_object_unref);
}
