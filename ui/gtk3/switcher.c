/* switcher.c generated by valac 0.56.12, the Vala compiler
...
enum  {
	SWITCHER_REALIZE_SURFACE_SIGNAL,
	SWITCHER_NUM_SIGNALS
};
static guint switcher_signals[SWITCHER_NUM_SIGNALS] = {0};
...
static void ___lambda45_ (Switcher* self,
                   GtkWidget* w);
static void switcher_realize_window (Switcher* self,
                              gboolean initial);
static void ____lambda45__gtk_widget_realize (GtkWidget* _sender,
                                       gpointer self);
static void ___lambda46_ (Switcher* self,
                   GtkWidget* w);
static void ____lambda46__gtk_widget_show (GtkWidget* _sender,
                                    gpointer self);
static void ___lambda47_ (Switcher* self,
                   GtkWidget* w);
static void ____lambda47__gtk_widget_hide (GtkWidget* _sender,
                                    gpointer self);
...
static gboolean ___lambda51_ (Switcher* self);
...
static SwitcherIBusEngineButton* switcher_ibus_engine_button_construct (GType object_type,
                                                                 ...
                                                                 Switcher* switcher);
static gboolean _____lambda48_ (Switcher* self,
                         GdkEventCrossing* e);
static gboolean ______lambda48__gtk_widget_enter_notify_event (GtkWidget* _sender,
                                                        GdkEventCrossing* event,
                                                        gpointer self);
static gboolean _____lambda49_ (Block11Data* _data11_,
                         GdkEventMotion* e);
...
static gboolean ______lambda49__gtk_widget_motion_notify_event (GtkWidget* _sender,
                                                         GdkEventMotion* event,
                                                         gpointer self);
static gboolean _____lambda50_ (Block11Data* _data11_,
                         GdkEventButton* e);
static gboolean ______lambda50__gtk_widget_button_press_event (GtkWidget* _sender,
                                                        GdkEventButton* event,
                                                        gpointer self);
static void switcher_ibus_engine_button_set_transname (SwitcherIBusEngineButton* self,
                                                const gchar* value);
static void _vala_array_add28 (SwitcherIBusEngineButton** * array,
                        gint* length,
                        gint* size,
...
static void
___lambda45_ (Switcher* self,
              GtkWidget* w)
{
	g_return_if_fail (w != NULL);
	switcher_realize_window (self, TRUE);
}

static void
____lambda45__gtk_widget_realize (GtkWidget* _sender,
                                  gpointer self)
{
	___lambda45_ ((Switcher*) self, _sender);
}

static void
___lambda46_ (Switcher* self,
              GtkWidget* w)
{
	g_return_if_fail (w != NULL);
	if (self->priv->m_hide_after_show) {
		switcher_realize_window (self, FALSE);
	}
	self->priv->m_hide_after_show = FALSE;
}

static void
____lambda46__gtk_widget_show (GtkWidget* _sender,
                               gpointer self)
{
	___lambda46_ ((Switcher*) self, _sender);
}

static void
___lambda47_ (Switcher* self,
              GtkWidget* w)
{
	g_return_if_fail (w != NULL);
...
static void
____lambda47__gtk_widget_hide (GtkWidget* _sender,
                               gpointer self)
{
	___lambda47_ ((Switcher*) self, _sender);
}
...
switcher_construct (GType object_type)
{
	...
	self->priv->m_label = _tmp7_;
	_tmp8_ = self->priv->m_label;
	_tmp9_ = gtk_widget_get_accessible ((GtkWidget*) _tmp8_);
	_tmp10_ = _g_object_ref0 (_tmp9_);
	obj = _tmp10_;
	_tmp11_ = obj;
	atk_object_set_role (_tmp11_, ATK_ROLE_STATUSBAR);
	_tmp12_ = self->priv->m_label;
	gtk_widget_set_margin_start ((GtkWidget*) _tmp12_, 3);
	_tmp13_ = self->priv->m_label;
	gtk_widget_set_margin_end ((GtkWidget*) _tmp13_, 3);
	_tmp14_ = self->priv->m_label;
	gtk_widget_set_margin_top ((GtkWidget*) _tmp14_, 3);
	_tmp15_ = self->priv->m_label;
	gtk_widget_set_margin_bottom ((GtkWidget*) _tmp15_, 3);
	_tmp16_ = vbox;
	_tmp17_ = self->priv->m_label;
	gtk_box_pack_end (_tmp16_, (GtkWidget*) _tmp17_, FALSE, FALSE, (guint) 0);
	if (!binding_common_default_is_xdisplay ()) {
		g_signal_connect_object ((GtkWidget*) self, "realize", (GCallback) ____lambda45__gtk_widget_realize, self, 0);
		g_signal_connect_object ((GtkWidget*) self, "show", (GCallback) ____lambda46__gtk_widget_show, self, 0);
		g_signal_connect_object ((GtkWidget*) self, "hide", (GCallback) ____lambda47__gtk_widget_hide, self, 0);
	} else {
...
gint
switcher_run_popup (Switcher* self,
                    IBusEngineDesc** engines,
                    gint engines_length1,
                    gint index)
{
	...
	_tmp1_ = self->priv->m_buttons;
	_tmp1__length1 = self->priv->m_buttons_length1;
	_tmp2_ = _tmp1_[index];
	_tmp3_ = switcher_ibus_engine_button_get_transname (_tmp2_);
	_tmp4_ = _tmp3_;
	gtk_label_set_text (_tmp0_, _tmp4_);
	gtk_widget_show_all ((GtkWidget*) self);
	_tmp5_ = self->priv->m_buttons;
	_tmp5__length1 = self->priv->m_buttons_length1;
	_tmp6_ = _tmp5_[index];
	gtk_window_set_focus ((GtkWindow*) self, (GtkWidget*) _tmp6_);
	_tmp7_ = self->priv->m_engines;
	_tmp7__length1 = self->priv->m_engines_length1;
	_tmp8_ = _tmp7_[self->priv->m_result];
	_tmp9_ = _g_object_ref0 (_tmp8_);
	_g_object_unref0 (self->priv->m_result_engine);
	self->priv->m_result_engine = _tmp9_;
	result = self->priv->m_result;
	return result;
}

static gboolean
___lambda51_ (Switcher* self)
{
	gboolean result;
...
{
	gboolean result;
	result = ___lambda51_ ((Switcher*) self);
	return result;
}
              ...
              const gchar* input_context_path)
{
	...
	gtk_widget_show_all ((GtkWidget*) self);
	if (self->priv->m_popup_delay_time > ((guint) 0)) {
		self->priv->m_popup_delay_time_id = g_timeout_add_full (G_PRIORITY_DEFAULT, self->priv->m_popup_delay_time, ____lambda51__gsource_func, g_object_ref (self), g_object_unref);
	}
	...
	if (status != GDK_GRAB_SUCCESS) {
		g_warning ("switcher.vala:240: Grab keyboard failed! status = %d", (gint) status);
	}
	_tmp24_ = seat;
	...
	if (status != GDK_GRAB_SUCCESS) {
		g_warning ("switcher.vala:248: Grab pointer failed! status = %d", (gint) status);
	}
	_tmp26_ = pointer;
...
static gboolean
______lambda48__gtk_widget_enter_notify_event (GtkWidget* _sender,
                                               GdkEventCrossing* event,
                                               gpointer self)
{
	gboolean result;
	result = _____lambda48_ ((Switcher*) self, event);
	return result;
}
...
static gboolean
_____lambda49_ (Block11Data* _data11_,
                GdkEventMotion* e)
{
	Switcher* self;
...
static gboolean
______lambda49__gtk_widget_motion_notify_event (GtkWidget* _sender,
                                                GdkEventMotion* event,
                                                gpointer self)
{
	gboolean result;
	result = _____lambda49_ (self, event);
	return result;
}

static gboolean
_____lambda50_ (Block11Data* _data11_,
                GdkEventButton* e)
{
	Switcher* self;
	GMainLoop* _tmp0_;
...
static gboolean
______lambda50__gtk_widget_button_press_event (GtkWidget* _sender,
                                               GdkEventButton* event,
                                               gpointer self)
{
	gboolean result;
	result = _____lambda50_ (self, event);
	return result;
}

static void
_vala_array_add28 (SwitcherIBusEngineButton** * array,
                   gint* length,
                   gint* size,
                   SwitcherIBusEngineButton* value)
{
	...
	max_label_width = 0;
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				g_signal_connect_object ((GtkWidget*) _tmp26_, "enter-notify-event", (GCallback) ______lambda48__gtk_widget_enter_notify_event, self, 0);
				_tmp27_ = _data11_->button;
				g_signal_connect_data ((GtkWidget*) _tmp27_, "motion-notify-event", (GCallback) ______lambda49__gtk_widget_motion_notify_event, block11_data_ref (_data11_), (GClosureNotify) block11_data_unref, 0);
				_tmp28_ = _data11_->button;
				g_signal_connect_data ((GtkWidget*) _tmp28_, "button-press-event", (GCallback) ______lambda50__gtk_widget_button_press_event, block11_data_ref (_data11_), (GClosureNotify) block11_data_unref, 0);
				...
				_vala_array_add28 (&self->priv->m_buttons, &self->priv->m_buttons_length1, &self->priv->_m_buttons_size_, _tmp38_);
				_g_free0 (transname);
				_g_free0 (textdomain);
				_g_free0 (longname);
...
static void
switcher_realize_window (Switcher* self,
                         gboolean initial)
{
	...
	window = _tmp1_;
	_tmp2_ = window;
	if (!gdk_window_ensure_native (_tmp2_)) {
		g_warning ("switcher.vala:469: No native window.");
		_g_object_unref0 (window);
		return;
	}
	_tmp3_ = window;
	instance_type = G_TYPE_FROM_INSTANCE ((GObject*) _tmp3_);
	wayland_type = gdk_wayland_window_get_type ();
	if (!g_type_is_a (instance_type, wayland_type)) {
		g_warning ("switcher.vala:475: Not GdkWindowWayland.");
		_g_object_unref0 (window);
		return;
	}
	if (initial) {
		GdkWindow* _tmp4_;
		_tmp4_ = window;
		gdk_wayland_window_set_use_custom_surface (G_TYPE_CHECK_INSTANCE_CAST (_tmp4_, gdk_wayland_window_get_type (), GdkWaylandWindow));
	}
	_tmp5_ = window;
	_tmp6_ = gdk_wayland_window_get_wl_surface (G_TYPE_CHECK_INSTANCE_CAST (_tmp5_, gdk_wayland_window_get_type (), GdkWaylandWindow));
	surface = _tmp6_;
	_tmp7_ = surface;
	g_signal_emit (self, switcher_signals[SWITCHER_REALIZE_SURFACE_SIGNAL], 0, _tmp7_);
	_g_object_unref0 (window);
}
		...
		while (TRUE) {
			...
			switch (_tmp5_->keyval) {
				...
				default:
				{
					GdkEventKey* _tmp6_;
					_tmp6_ = pe;
					g_debug ("switcher.vala:533: 0x%04x", _tmp6_->keyval);
					break;
				}
			}
		}
                     ...
                     gpointer klass_data)
{
	...
	switcher_signals[SWITCHER_REALIZE_SURFACE_SIGNAL] = g_signal_new ("realize-surface", TYPE_SWITCHER, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_marshal_VOID__POINTER, G_TYPE_NONE, 1, G_TYPE_POINTER);
}
