/* bindingcommon.c generated by valac 0.52.4, the Vala compiler
                                        ...
                                        gpointer handler_reverse_target)
{
	...
	BindingCommonKeybinding* _tmp19_;
	BindingCommonKeybinding* _tmp20_;
	...
	if ((_tmp2_ & VIRTUAL_MODIFIERS) != 0) {
		...
		_tmp4_ = gdk_keymap_get_for_display (_tmp3_);
	...
	_tmp9_ = binding_common_keybinding_new (switch_keysym, _tmp8_, FALSE, ftype);
	_g_object_unref0 (keybinding);
	keybinding = _tmp9_;
	_tmp10_ = keybinding;
	_tmp11_ = _g_object_ref0 (_tmp10_);
	*keybindings = g_list_append (*keybindings, _tmp11_);
	_tmp12_ = switch_modifiers;
	keybinding_manager_bind (keybinding_manager, switch_keysym, _tmp12_, handler_normal, handler_normal_target);
	if (ftype == BINDING_COMMON_KEY_EVENT_FUNC_TYPE_EMOJI_TYPING) {
		_g_object_unref0 (keybinding);
		return;
	}
	_tmp13_ = switch_modifiers;
	_tmp14_ = reverse_modifier;
	...
	switch_modifiers = _tmp15_ | _tmp16_;
	_tmp17_ = switch_modifiers;
	_tmp18_ = binding_common_keybinding_new (switch_keysym, _tmp17_, TRUE, ftype);
	_g_object_unref0 (keybinding);
	keybinding = _tmp18_;
	_tmp19_ = keybinding;
	_tmp20_ = _g_object_ref0 (_tmp19_);
	*keybindings = g_list_append (*keybindings, _tmp20_);
	if (ftype == BINDING_COMMON_KEY_EVENT_FUNC_TYPE_IME_SWITCHER) {
		GdkModifierType _tmp21_;
		_tmp21_ = switch_modifiers;
		keybinding_manager_bind (keybinding_manager, switch_keysym, _tmp21_, handler_reverse, handler_reverse_target);
	}
	_g_object_unref0 (keybinding);
	return;
}
