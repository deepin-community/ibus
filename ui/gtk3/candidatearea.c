/* candidatearea.c generated by valac 0.56.12, the Vala compiler
...
static void __lambda30_ (CandidateArea* self,
                  GtkButton* b);
static void ___lambda30__gtk_button_clicked (GtkButton* _sender,
                                      gpointer self);
static void __lambda31_ (CandidateArea* self,
                  GtkButton* b);
...
static void _vala_array_add2 (GtkLabel** * array,
                       ...
                       gint* size,
                       GtkLabel* value);
static void _vala_array_add3 (GtkLabel** * array,
                       gint* length,
                       gint* size,
                       GtkLabel* value);
static gboolean ______lambda32_ (Block2Data* _data2_,
                          GtkWidget* w,
                          GdkEventButton* e);
static gboolean _______lambda32__gtk_widget_button_press_event (GtkWidget* _sender,
...
static void _vala_array_add4 (GtkWidget** * array,
                       ...
                       gint* size,
                       GtkWidget* value);
static gboolean ______lambda33_ (Block2Data* _data2_,
                          GtkWidget* w,
                          GdkEventButton* e);
static gboolean _______lambda33__gtk_widget_button_press_event (GtkWidget* _sender,
                                                         GdkEventButton* event,
                                                         gpointer self);
static void _vala_array_add5 (GtkWidget** * array,
                       gint* length,
                       gint* size,
                       GtkWidget* value);
...
static void _vala_array_add6 (GtkLabel** * array,
                       ...
                       gint* size,
                       GtkLabel* value);
static void _vala_array_add7 (GtkLabel** * array,
                       gint* length,
                       gint* size,
                       GtkLabel* value);
static gboolean ______lambda34_ (Block3Data* _data3_,
                          GtkWidget* w,
                          GdkEventButton* e);
static gboolean _______lambda34__gtk_widget_button_press_event (GtkWidget* _sender,
                                                         GdkEventButton* event,
                                                         gpointer self);
static void _vala_array_add8 (GtkWidget** * array,
                       gint* length,
                       gint* size,
                       GtkWidget* value);
...
static void
__lambda30_ (CandidateArea* self,
             GtkButton* b)
{
...
___lambda30__gtk_button_clicked (GtkButton* _sender,
                                 gpointer self)
{
	__lambda30_ ((CandidateArea*) self, _sender);
}

static void
__lambda31_ (CandidateArea* self,
             GtkButton* b)
{
	g_return_if_fail (b != NULL);
...
___lambda31__gtk_button_clicked (GtkButton* _sender,
                                 gpointer self)
{
	__lambda31_ ((CandidateArea*) self, _sender);
}
...
static void
_vala_array_add3 (GtkLabel** * array,
                  gint* length,
                  gint* size,
                  GtkLabel* value)
{
...
static gboolean
______lambda32_ (Block2Data* _data2_,
                 GtkWidget* w,
                 GdkEventButton* e)
{
	Block1Data* _data1_;
...
static gboolean
_______lambda32__gtk_widget_button_press_event (GtkWidget* _sender,
                                                GdkEventButton* event,
                                                gpointer self)
{
	gboolean result;
	result = ______lambda32_ (self, _sender, event);
	return result;
}
...
static gboolean
______lambda33_ (Block2Data* _data2_,
                 GtkWidget* w,
                 GdkEventButton* e)
{
	Block1Data* _data1_;
...
static gboolean
_______lambda33__gtk_widget_button_press_event (GtkWidget* _sender,
                                                GdkEventButton* event,
                                                gpointer self)
{
	gboolean result;
	result = ______lambda33_ (self, _sender, event);
	return result;
}

static void
_vala_array_add5 (GtkWidget** * array,
                  gint* length,
                  gint* size,
                  GtkWidget* value)
{
...
static void
_vala_array_add7 (GtkLabel** * array,
                  gint* length,
                  gint* size,
                  GtkLabel* value)
{
...
static gboolean
______lambda34_ (Block3Data* _data3_,
                 GtkWidget* w,
                 GdkEventButton* e)
{
	CandidateArea* self;
...
static gboolean
_______lambda34__gtk_widget_button_press_event (GtkWidget* _sender,
                                                GdkEventButton* event,
                                                gpointer self)
{
	gboolean result;
	result = ______lambda34_ (self, _sender, event);
	return result;
}

static void
_vala_array_add8 (GtkWidget** * array,
                  gint* length,
                  gint* size,
                  GtkWidget* value)
{
...
candidate_area_recreate_ui (CandidateArea* self)
{
	...
	next_button = _tmp12_;
	_tmp13_ = next_button;
	g_signal_connect_object (_tmp13_, "clicked", (GCallback) ___lambda31__gtk_button_clicked, self, 0);
	_tmp14_ = next_button;
		...
		self->priv->_m_widgets_size_ = self->priv->m_widgets_length1;
		{
			...
			_data1_->i = 0;
			{
				...
				while (TRUE) {
					...
					_vala_array_add2 (&self->priv->m_labels, &self->priv->m_labels_length1, &self->priv->_m_labels_size_, _tmp67_);
					...
					_vala_array_add3 (&self->priv->m_candidates, &self->priv->m_candidates_length1, &self->priv->_m_candidates_size_, _tmp73_);
					_tmp74_ = label;
					...
					_tmp80_ = label_ebox;
					g_signal_connect_data ((GtkWidget*) _tmp80_, "button-press-event", (GCallback) _______lambda32__gtk_widget_button_press_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
					_tmp81_ = label_ebox;
					_tmp82_ = label;
					...
					_vala_array_add4 (&self->priv->m_widgets, &self->priv->m_widgets_length1, &self->priv->_m_widgets_size_, _tmp86_);
					...
					g_signal_connect_data ((GtkWidget*) _tmp89_, "button-press-event", (GCallback) _______lambda33__gtk_widget_button_press_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
					...
					_vala_array_add5 (&self->priv->m_widgets, &self->priv->m_widgets_length1, &self->priv->_m_widgets_size_, _tmp95_);
		...
		self->priv->_m_widgets_size_ = self->priv->m_widgets_length1;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_vala_array_add6 (&self->priv->m_labels, &self->priv->m_labels_length1, &self->priv->_m_labels_size_, _tmp114_);
					...
					_vala_array_add7 (&self->priv->m_candidates, &self->priv->m_candidates_length1, &self->priv->_m_candidates_size_, _tmp120_);
					...
					_tmp129_ = ebox;
					g_signal_connect_data ((GtkWidget*) _tmp129_, "button-press-event", (GCallback) _______lambda34__gtk_widget_button_press_event, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
					_tmp130_ = ebox;
					...
					_vala_array_add8 (&self->priv->m_widgets, &self->priv->m_widgets_length1, &self->priv->_m_widgets_size_, _tmp135_);
