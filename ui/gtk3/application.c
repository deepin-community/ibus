/* application.c generated by valac 0.52.4, the Vala compiler
                                  ...
                                  GVariant* parameters)
{
	...
	g_debug ("application.vala:77: signal_name = %s", signal_name);
	_tmp0_ = self->priv->m_bus;
                              ...
                              GVariant* parameters)
{
	...
	g_return_if_fail (signal_name != NULL);
	g_return_if_fail (parameters != NULL);
	g_debug ("application.vala:94: signal_name = %s", signal_name);
                              ...
                              IBusBus* bus)
{
	...
	g_debug ("application.vala:102: connection is lost.");
	gtk_main_quit ();
}
