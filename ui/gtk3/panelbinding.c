/* panelbinding.c generated by valac 0.56.12, the Vala compiler
...
static void ___lambda39__g_settings_changed (GSettings* _sender,
                                      const gchar* key,
                                      gpointer self);
static void __lambda40_ (PanelBinding* self,
                  const gchar* key);
static void ___lambda40__g_settings_changed (GSettings* _sender,
                                      const gchar* key,
                                      gpointer self);
static void __lambda41_ (PanelBinding* self,
                  const gchar* key);
static void ___lambda41__g_settings_changed (GSettings* _sender,
                                      const gchar* key,
                                      gpointer self);
static void __lambda42_ (PanelBinding* self,
                  const gchar* key);
...
static void ___lambda42__g_settings_changed (GSettings* _sender,
                                      const gchar* key,
                                      gpointer self);
static void __lambda43_ (PanelBinding* self,
                  const gchar* key);
...
static gboolean __lambda38_ (PanelBinding* self);
...
static gboolean ___lambda44_ (PanelBinding* self);
...
VALA_EXTERN IBusEmojier* ibus_emojier_construct (GType object_type,
                                     gboolean is_wayland);
static void ___lambda45_ (PanelBinding* self,
                   guint i,
                   guint b,
                   guint s);
static void panel_binding_candidate_clicked_lookup_table_real (PanelBinding* self,
                                                        ...
                                                        guint state,
                                                        gboolean is_emojier);
static void ____lambda45__ibus_emojier_candidate_clicked (IBusEmojier* _sender,
                                                   guint index,
                                                   guint button,
                                                   guint state,
                                                   gpointer self);
static void ___lambda46_ (PanelBinding* self,
                   const gchar* s);
static void ____lambda46__ibus_emojier_commit_text (IBusEmojier* _sender,
                                             const gchar* text,
                                             gpointer self);
...
___lambda40__g_settings_changed (GSettings* _sender,
                                 ...
                                 gpointer self)
{
	__lambda40_ ((PanelBinding*) self, key);
}

static void
__lambda41_ (PanelBinding* self,
             const gchar* key)
{
	g_return_if_fail (key != NULL);
	panel_binding_set_emoji_partial_match (self);
...
___lambda41__g_settings_changed (GSettings* _sender,
                                 ...
                                 gpointer self)
{
	__lambda41_ ((PanelBinding*) self, key);
}

static void
__lambda42_ (PanelBinding* self,
             const gchar* key)
{
	g_return_if_fail (key != NULL);
...
___lambda42__g_settings_changed (GSettings* _sender,
                                 ...
                                 gpointer self)
{
	__lambda42_ ((PanelBinding*) self, key);
}

static void
__lambda43_ (PanelBinding* self,
             const gchar* key)
{
	g_return_if_fail (key != NULL);
...
___lambda43__g_settings_changed (GSettings* _sender,
                                 ...
                                 gpointer self)
{
	__lambda43_ ((PanelBinding*) self, key);
}
...
panel_binding_init_settings (PanelBinding* self)
{
	...
	g_signal_connect_object (_tmp4_, "changed::custom-theme", (GCallback) ___lambda28__g_settings_changed, self, 0);
	_tmp5_ = self->priv->m_settings_panel;
	g_signal_connect_object (_tmp5_, "changed::use-custom-theme", (GCallback) ___lambda29__g_settings_changed, self, 0);
	_tmp6_ = self->priv->m_settings_panel;
	g_signal_connect_object (_tmp6_, "changed::custom-icon", (GCallback) ___lambda30__g_settings_changed, self, 0);
	_tmp7_ = self->priv->m_settings_panel;
	g_signal_connect_object (_tmp7_, "changed::use-custom-icon", (GCallback) ___lambda31__g_settings_changed, self, 0);
	_tmp8_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp8_, "changed::unicode-hotkey", (GCallback) ___lambda32__g_settings_changed, self, 0);
	_tmp9_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp9_, "changed::font", (GCallback) ___lambda33__g_settings_changed, self, 0);
	_tmp10_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp10_, "changed::hotkey", (GCallback) ___lambda34__g_settings_changed, self, 0);
	_tmp11_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp11_, "changed::favorites", (GCallback) ___lambda35__g_settings_changed, self, 0);
	_tmp12_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp12_, "changed::favorite-annotations", (GCallback) ___lambda36__g_settings_changed, self, 0);
	_tmp13_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp13_, "changed::lang", (GCallback) ___lambda37__g_settings_changed, self, 0);
	_tmp14_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp14_, "changed::has-partial-match", (GCallback) ___lambda39__g_settings_changed, self, 0);
	_tmp15_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp15_, "changed::partial-match-length", (GCallback) ___lambda40__g_settings_changed, self, 0);
	_tmp16_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp16_, "changed::partial-match-condition", (GCallback) ___lambda41__g_settings_changed, self, 0);
	_tmp17_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp17_, "changed::load-emoji-at-startup", (GCallback) ___lambda42__g_settings_changed, self, 0);
	_tmp18_ = self->priv->m_settings_emoji;
	g_signal_connect_object (_tmp18_, "changed::load-unicode-at-startup", (GCallback) ___lambda43__g_settings_changed, self, 0);
}
                                 ...
                                 const gchar* accelerator)
{
	...
	if (_tmp3_) {
		...
		_tmp5_ = _tmp4_;
		g_warning ("panelbinding.vala:346: %s", _tmp5_);
		_g_free0 (_tmp5_);
		return;
	}
...
{
	gboolean result;
	result = __lambda38_ ((PanelBinding*) self);
	return result;
}
...
panel_binding_set_emoji_lang (PanelBinding* self)
{
	...
	self->priv->m_emojier_set_emoji_lang_id = g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, ___lambda38__gsource_func, g_object_ref (self), g_object_unref);
}
...
panel_binding_load_settings (PanelBinding* self)
{
	...
	binding_common_set_custom_font (_tmp0_, _tmp1_, &self->priv->m_css_provider);
	_tmp2_ = self->priv->m_settings_panel;
	binding_common_set_custom_theme (_tmp2_);
	_tmp3_ = self->priv->m_settings_panel;
	binding_common_set_custom_icon (_tmp3_);
	panel_binding_set_emoji_favorites (self);
	...
	if (_tmp5_) {
		...
		if (g_strcmp0 (_tmp8_, _tmp9_) != 0) {
			if (self->priv->m_is_wayland) {
				const gchar* _tmp10_;
				const gchar* _tmp11_;
				_tmp10_ = prev_context_path;
				_tmp11_ = self->priv->m_current_context_path;
				g_debug ("panelbinding.vala:510: Prev input context path %s, now %s", _tmp10_, _tmp11_);
			} else {
				result = FALSE;
		...
		_tmp12_ = selected_string;
		_tmp13_ = ibus_text_new_from_string (_tmp12_);
		g_object_ref_sink (_tmp13_);
		text = _tmp13_;
		_tmp14_ = text;
		panel_binding_commit_text_update_favorites (self, _tmp14_, FALSE);
		_tmp15_ = self->priv->m_emojier;
		ibus_emojier_reset (_tmp15_);
		result = TRUE;
...
static gboolean
___lambda44_ (PanelBinding* self)
{
	gboolean result;
...
{
	gboolean result;
	result = ___lambda44_ ((PanelBinding*) self);
	return result;
}
...
panel_binding_emojier_focus_commit (PanelBinding* self)
{
	...
	if (_tmp5_) {
		...
		self->priv->m_emojier_focus_commit_text_id = g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 100, ____lambda44__gsource_func, g_object_ref (self), g_object_unref);
                                          ...
                                          gboolean show_candidate)
{
	...
	if (_tmp2_) {
		...
		gchar* _tmp5_;
		_tmp3_ = self->priv->m_preedit;
		_tmp4_ = preedit_get_text (_tmp3_);
		_tmp5_ = _tmp4_;
	...
	if (_tmp1_) {
		...
		visible = FALSE;
		_tmp7_ = ibus_text_new_from_static_string ("");
		...
		IBusText* _tmp9_;
		_tmp8_ = self->priv->m_preedit;
		_tmp9_ = preedit_get_engine_preedit_text (_tmp8_);
		_g_object_unref0 (text);
		text = _tmp9_;
	}
	_tmp10_ = text;
	ibus_panel_service_update_preedit_text_received ((IBusPanelService*) self, _tmp10_, cursor_pos, visible);
	if (!show_candidate) {
		panel_binding_hide_emoji_lookup_table (self);
		_g_object_unref0 (text);
		return;
...
static void
___lambda45_ (PanelBinding* self,
              guint i,
              guint b,
              guint s)
{
...
static void
____lambda45__ibus_emojier_candidate_clicked (IBusEmojier* _sender,
                                              guint index,
                                              guint button,
                                              guint state,
                                              gpointer self)
{
	___lambda45_ ((PanelBinding*) self, index, button, state);
}

static void
___lambda46_ (PanelBinding* self,
              const gchar* s)
{
...
static void
____lambda46__ibus_emojier_commit_text (IBusEmojier* _sender,
                                        const gchar* text,
                                        gpointer self)
{
	___lambda46_ ((PanelBinding*) self, text);
}
                                             ...
                                             IBusExtensionEvent* event)
{
	...
	if (_tmp2_) {
		...
		_tmp9_ = _tmp8_;
		g_warning ("panelbinding.vala:871: %s", _tmp9_);
		_g_free0 (_tmp9_);
		_tmp10_ = g_strdup ("");
		_g_free0 (self->priv->m_extension_name);
	...
	if (_tmp14_ == NULL) {
		...
		g_signal_connect_object (_tmp18_, "candidate-clicked", (GCallback) ____lambda45__ibus_emojier_candidate_clicked, self, 0);
		_tmp19_ = self->priv->m_emojier;
		g_signal_connect_object (_tmp19_, "commit-text", (GCallback) ____lambda46__ibus_emojier_commit_text, self, 0);
	}
...
panel_binding_real_hide_preedit_text (IBusPanelService* base)
{
	...
	if (self->priv->m_is_wayland) {
		...
		gchar* _tmp4_;
		_tmp2_ = self->priv->m_preedit;
		_tmp3_ = preedit_get_text (_tmp2_);
		_tmp4_ = _tmp3_;
