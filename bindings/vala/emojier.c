                                ...
                                gboolean initial_launching)
{
	...
	self->priv->m_rebuilding_gui_timeout_id = g_timeout_add_seconds_full (G_PRIORITY_DEFAULT_IDLE, (guint) 5, ___lambda15__gsource_func, g_object_ref (self), g_object_unref);
}
