		...
		self->priv->_m_widgets_size_ = self->priv->m_widgets_length1;
		{
			...
			_data1_->i = 0;
			{
				...
				while (TRUE) {
					...
					_tmp80_ = label_ebox;
					g_signal_connect_data ((GtkWidget*) _tmp80_, "button-press-event", (GCallback) _______lambda7__gtk_widget_button_press_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
					_tmp81_ = label_ebox;
					_tmp82_ = label;
					...
					g_signal_connect_data ((GtkWidget*) _tmp89_, "button-press-event", (GCallback) _______lambda8__gtk_widget_button_press_event, block2_data_ref (_data2_), (GClosureNotify) block2_data_unref, 0);
		...
		self->priv->_m_widgets_size_ = self->priv->m_widgets_length1;
		{
			...
			i = 0;
			{
				...
				while (TRUE) {
					...
					_tmp129_ = ebox;
					g_signal_connect_data ((GtkWidget*) _tmp129_, "button-press-event", (GCallback) _______lambda9__gtk_widget_button_press_event, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
					_tmp130_ = ebox;
